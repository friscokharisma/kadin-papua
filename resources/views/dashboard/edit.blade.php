        ...
        <form
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="title" value="{{ $post->title }}"> {{-- id="exampleInputEmail1"  --}}
            </div>
            <div class="form-group">
                <label>Description</label>
                <textarea class="form-control" name="description" rows="12"> {{ $post->description }} </textarea>
            </div>
            {{-- <div class="form-group">
